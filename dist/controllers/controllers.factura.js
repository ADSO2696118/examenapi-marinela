...
exports.mostrarFactura = exports.modificarFactura = exports.eliminarFactura = exports.crearFactura = exports.ListarFactura = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.next = 4;
          return _dbMysql.pool.query("CALL sp_ModificarFactura(".concat(id, ");"));
        case 4:
          ...
          if (respuesta[0].affectedRows == 1) {
            ...
            res.json({
              "error": "No se puedo Modificar la factura"
            });
          }
          _context4.next = 11;
          break;
